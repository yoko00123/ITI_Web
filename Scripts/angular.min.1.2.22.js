!function (t, e, n) {
    ...
    function r(t) {
        return function () {
            var e, n = arguments[0], n = "[" + (t ? t + ":" : "") + n + "] http://errors.angularjs.org/1.2.22/" + (t ? t + "/" : "") + n;
    ...
    function c() {
        for (var t, e = rr.length; e;) {
            ...
            57 == t)
                ...
                rr.join("");
            if (90 != t)
                return rr[e] = String.fromCharCode(t + 1),
                rr.join("");
            rr[e] = "0"
        }
        return rr.unshift("0"),
    ...
    function M(t, e, n, r) {
        ...
        if (e) {
            ...
            (e = t) && (ir(t) ? e = M(t, [], n, r) : x(t) ? e = new Date(t.getTime()) : C(t) ? (e = RegExp(t.source, t.toString().match(/[^\/]*$/)[0]),
                    e.lastIndex = t.lastIndex) : y(t) && (e = M(t, {}, n, r)));
        return e
    }
    function N(t, e) {
        if (ir(t)) {
            ...
            for (n in e = e || {},
            t)
                !Xn.call(t, n) || "$" === n.charAt(0) && "$" === n.charAt(1) || (e[n] = t[n]);
        return e || t
    }
    function P(t, e) {
        if (t === e)
        ...
        if (i == typeof e && "object" == i) {
            if (!ir(t)) {
                if (x(t))
                    return x(e) && t.getTime() == e.getTime();
                if (C(t) && C(e))
                    return t.toString() == e.toString();
                if (t && t.$evalAsync && t.$watch || e && e.$evalAsync && e.$watch || k(t) || k(e) || ir(e))
                    return !1;
                i = {};
                for (r in t)
                    if ("$" !== r.charAt(0) && !S(t[r])) {
    ...
    function q(t) {
        return "function" == typeof t ? t = !0 : t && 0 !== t.length ? (t = Jn("" + t),
    ...
    function _(t) {
        ...
        return o((t || "").split("&"), function (t) {
            ...
            n = F(e[0]),
            m(n) && (t = m(e[1]) ? F(e[1]) : !0,
            Xn.call(r, n) ? ir(r[n]) ? r[n].push(t) : r[n] = [r[n], t] : r[n] = t))
        }),
        r
    }
    function I(t) {
    ...
    function B(t, n) {
        ...
        o(u, function (n) {
            ...
            n = n.replace(":", "\\:"),
            t.querySelectorAll && (o(t.querySelectorAll("." + n), r),
        ...
        o(a, function (t) {
            if (!i) {
                ...
                e ? (i = t,
                s = (e[2] || "").replace(/\s+/g, ",")) : o(t.attributes, function (e) {
                    !i && u[e.name] && (i = t,
                    s = e.value)
                })
            }
    ...
    function z(n, r) {
        var i = function () {
            ...
            r.unshift("ng"),
            t = be(r),
            t.invoke(["$rootScope", "$rootElement", "$compile", "$injector", "$animate", function (t, e, n, r) {
                t.$apply(function () {
                    e.data("$injector", r),
                    n(e)(t)
                })
        ...
        void (nr.resumeBootstrap = function (t) {
            o(t, function (t) {
                r.push(t)
            }),
            i()
    ...
    function W(t, e) {
        return e = e || "_",
        t.replace(ar, function (t, n) {
            return (n ? e : "") + t.toLowerCase()
        })
    }
    function Q(t, e, n) {
        if (!t)
            throw er("areq", e || "?", n || "required");
        return t
    }
    function G(t, e, n) {
        return n && ir(t) && (t = t[t.length - 1]),
        Q(S(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)),
        t
    }
    function J(t, e) {
        if ("hasOwnProperty" === t)
    ...
    function Z(t) {
        ...
        t.module || (t.module = function () {
            ...
            return function (r, i, o) {
                ...
                return i && t.hasOwnProperty(r) && (t[r] = null),
                t[r] || (t[r] = function () {
                    function t(t, e, r) {
                        return function () {
                            return n[r || "push"]([t, e, arguments]),
                            u
                        }
                    }
                    if (!i)
    ...
    function ne(t) {
        ...
        if (w(t)) {
            ...
            if (r = vr.exec(n))
                ...
                var i, o = t;
                if (t = o.createDocumentFragment(),
                r = [],
                gr.test(n)) {
                    for (o = t.appendChild(o.createElement("div")),
                    i = (mr.exec(n) || ["", ""])[1].toLowerCase(),
                    i = wr[i] || wr._default,
                    o.innerHTML = "<div>&#160;</div>" + i[1] + n.replace(yr, "<$1></$2>") + i[2],
                    o.removeChild(o.firstChild),
                    n = i[0]; n--;)
                        o = o.lastChild;
                    for (n = 0,
                    i = o.childNodes.length; i > n; ++n)
            ...
            he(this, t),
            Bn(e.createDocumentFragment()).append(this)
        } else
            he(this, t)
    }
    function re(t) {
    ...
    function we(t) {
        var e, n;
        return "function" == typeof t ? (e = t.$inject) || (e = [],
        t.length && (n = t.toString().replace(Ar, ""),
        n = n.match(Cr),
        o(n[1].split(kr), function (t) {
            t.replace(Er, function (t, n, r) {
                e.push(r)
            })
        })),
        t.$inject = e) : ir(t) ? (n = t.length - 1,
        G(t[n], "fn"),
        e = t.slice(0, n)) : G(t, "fn", !0),
        e
    }
    function be(t) {
        function e(t) {
            ...
            return o(t, function (t) {
                if (!f.get(t)) {
                    ...
                    try {
                        if (w(t))
                            for (e = Wn(t),
                            a = a.concat(i(e.requires)).concat(e._runBlocks),
                            n = e._invokeQueue,
                            r = 0,
                            s = n.length; s > r; r++) {
                                var o = n[r]
                            ...
                            S(t) ? a.push(p.invoke(t)) : ir(t) ? a.push(p.invoke(t)) : G(t, "module")
                    } catch (c) {
                        throw ir(t) && (t = t[t.length - 1]),
                        c.message && c.stack && -1 == c.stack.indexOf(c.message) && (c = c.message + "\n" + c.stack),
        ...
        function s(t, e) {
            ...
            return {
                ...
                instantiate: function (t, e) {
                    var n, i = function () { };
                    return i.prototype = (ir(t) ? t[t.length - 1] : t).prototype,
                    i = new i,
                    n = r(t, i, e),
                    y(n) || S(n) ? n : i
                },
    ...
    function Ce(t, e, r, i) {
        ...
        var S = f.href
          ...
          , k = null;
        c.url = function (e, n) {
            return f !== t.location && (f = t.location),
            h !== t.history && (h = t.history),
            e ? S != e ? (S = e,
            i.history ? n ? h.replaceState(null, "", e) : (h.pushState(null, "", e),
            C.attr("href", C.attr("href"))) : (k = e,
            n ? f.replace(e) : f.href = e),
            c) : void 0 : k || f.href.replace(/%27/g, "'")
        }
        ;
        var E = []
          , A = !1;
        c.onUrlChange = function (e) {
            return A || (i.history && Bn(t).on("popstate", u),
            i.hashchange ? Bn(t).on("hashchange", u) : c.addPollFn(u),
            A = !0),
            E.push(e),
            e
        }
            ...
            if (!t) {
                if (l.cookie !== T)
                    ...
                    s = 0; s < i.length; s++)
                        o = i[s],
                        a = o.indexOf("="),
                        a > 0 && (t = unescape(o.substring(0, a)),
                        O[t] === n && (O[t] = unescape(o.substring(a + 1))));
                return O
            }
            e === n ? l.cookie = escape(t) + "=;path=" + M + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : w(e) && (i = (l.cookie = escape(t) + "=" + escape(e) + ";path=" + M).length + 1,
            ...
            function t(t, n) {
                ...
                return e[t] = {
                    put: function (t, e) {
                        ...
                        return g(e) ? void 0 : (t in u || s++,
                        u[t] = e,
                        s > c && this.remove(p.key),
                        e)
                    },
                    get: function (t) {
                        if (c < Number.MAX_VALUE) {
    ...
    function Oe(t, r) {
        ...
        this.aHrefSanitizationWhitelist = function (t) {
            return m(t) ? (r.aHrefSanitizationWhitelist(t),
            this) : r.aHrefSanitizationWhitelist()
        }
        ,
        this.imgSrcSanitizationWhitelist = function (t) {
            return m(t) ? (r.imgSrcSanitizationWhitelist(t),
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (t, r, u, h, $, v, g, m, b, x, C, k) {
            ...
            function O(t, e, r, i, o, s) {
                function a(t, r, i, o) {
                    ...
                    l = h.length; l > c; f++)
                        ...
                        s = h[c++],
                        r ? (r.scope ? (u = t.$new(),
                        Bn.data(a, "$scope", u)) : u = t,
                        p = r.transcludeOnThisElement ? T(t, r.transclude, o) : !r.templateOnThisElement && o ? o : !o && e ? T(t, e) : null,
                        r(s, u, a, i, p)) : s && s(t, a.childNodes, n, o)
                }
                for (var u, c, l, f, h = [], p = 0; p < t.length; p++)
                    u = new X,
                    c = M(t[p], [], u, 0 === p ? i : n, o),
                    (s = c.length ? R(c, t[p], u, e, r, null, [], [], s) : null) && s.scope && A(u.$$element, "ng-scope"),
                    u = s && s.terminal || !(l = t[p].childNodes) || !l.length ? null : O(l, s ? (s.transcludeOnThisElement || !s.templateOnThisElement) && s.transclude : e),
                    h.push(s, u),
                    f = f || s || u,
                    s = null;
                return f ? a : null
            ...
            function M(t, e, n, r, i) {
                ...
                switch (t.nodeType) {
                    ...
                    case 8:
                        try {
                            (o = a.exec(t.nodeValue)) && (u = Te(o[1]),
                            q(e, u, "M", r, i) && (n[u] = or(o[2])))
                        } catch (m) { }
                }
                return e.sort(I),
                e
            ...
            function j(t, e, n) {
                ...
                if (e && t.hasAttribute && t.hasAttribute(e)) {
                    do {
                        if (!t)
                            throw Nr("uterdir", e, n);
                        1 == t.nodeType && (t.hasAttribute(e) && i++,
                        t.hasAttribute(n) && i--),
                        r.push(t),
                        t = t.nextSibling
                    } while (i > 0)
            ...
            function R(t, i, s, a, c, l, f, h, p) {
                ...
                function m(t, e, a, c, l) {
                    ...
                    var $, m, y, w, b, x, S, C = {};
                    if ($ = i === a ? s : N(s, new X(Bn(a), s.$attr)),
                    m = $.$$element,
                    q) {
                        var k = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                        x = e.$new(!0),
                        !I || I !== q && I !== q.$$originalDirective ? m.data("$isolateScopeNoTemplate", x) : m.data("$isolateScope", x),
                        A(m, "ng-isolate-scope"),
                        o(q.scope, function (t, n) {
                            var i, o, s, a, u = t.match(k) || [], c = u[3] || n, l = "?" == u[2], u = u[1];
                            switch (x.$$isolateBindings[n] = u + c,
                            u) {
                                case "@":
                                ...
                                case "=":
                                    if (l && !$[c])
                                        break;
                                    o = v($[c]),
                                    a = o.literal ? P : function (t, e) {
                                        return t === e || t !== t && e !== e
                                    }
                                    ,
                                    s = o.assign || function () {
                                        throw i = x[n] = o(e),
                                        Nr("nonassign", $[c], q.name)
                                    }
                                    ,
                                    i = x[n] = o(e),
                                    x.$watch(function () {
                                        var t = o(e);
                                        return a(t, x[n]) || (a(t, i) ? s(e, t = x[n]) : x[n] = t),
                                        i = t
                                    }, null, o.literal);
                                    break;
                                case "&":
                    ...
                    for (c = e,
                    q && (q.template || null === q.templateUrl) && (c = x),
                ...
                for (var b, x, C, k, O, T = -Number.MAX_VALUE, R = p.controllerDirectives, q = p.newIsolateScopeDirective, I = p.templateDirective, L = p.nonTlbTranscludeDirective, B = !1, z = !1, W = p.hasElementTranscludeDirective, Q = s.$$element = Bn(i), K = a, Z = 0, te = t.length; te > Z; Z++) {
                    ...
                    T > x.priority)
                        break;
                    if ((k = x.scope) && (b = b || x,
                    x.templateUrl || (H("new/isolated scope", q, x, Q),
                    y(k) && (q = x))),
                    C = x.name,
                    !x.templateUrl && x.controller && (k = x.controller,
                    R = R || {},
                    H("'" + C + "' controller", R[C], x, Q),
                    R[C] = x),
                    (k = x.transclude) && (B = !0,
                    x.$$tlb || (H("transclusion", L, x, Q),
                    L = x),
                    "element" == k ? (W = !0,
                    T = x.priority,
                    k = Q,
                    Q = s.$$element = Bn(e.createComment(" " + C + ": " + s[C] + " ")),
                    i = Q[0],
                    G(c, Zn.call(k, 0), i),
                    K = E(k, a, T, l && l.name, {
                    ...
                    x.template)
                        ...
                        H("template", I, x, Q),
                        I = x,
                        k = S(x.template) ? x.template(Q, s) : x.template,
                        k = Y(k),
                        x.replace) {
                            if (l = x,
                            k = gr.test(k) ? Bn(or(k)) : [],
                            i = k[0],
                            1 != k.length || 1 !== i.nodeType)
                                throw Nr("tplrt", C, "");
                            G(c, Q, i),
                            te = {
                                $attr: {}
                    ...
                    if (x.templateUrl)
                        ...
                        I = x,
                        x.replace && (l = x),
                        m = _(t.splice(Z, t.length - Z), Q, s, c, B && K, f, h, {
                        ...
                        try {
                            O = x.compile(Q, s, K),
                            S(O) ? $(null, O, ee, ne) : O && $(O.pre, O.post, ee, ne)
                        } catch (oe) {
                            u(oe, U(Q))
                        }
                    x.terminal && (m.terminal = !0,
                    T = Math.max(T, x.priority))
                }
                return m.scope = b && !0 === b.scope,
                m.transcludeOnThisElement = B,
                m.templateOnThisElement = z,
                m.transclude = K,
                p.hasElementTranscludeDirective = W,
                m
            }
            function V(t) {
            ...
            function q(e, r, o, a, c, l, f) {
                ...
                i.hasOwnProperty(r)) {
                    ...
                    for (var $ = 0, d = r.length; d > $; $++)
                        try {
                            h = r[$],
                            (a === n || a > h.priority) && -1 != h.restrict.indexOf(o) && (l && (h = p(h, {
                                $$start: l,
                                $$end: f
                            })),
                            e.push(h),
            ...
            function F(t, e) {
                ...
                o(e, function (e, o) {
                    "class" == o ? (A(i, e),
                    t["class"] = (t["class"] ? t["class"] + " " : "") + e) : "style" == o ? (i.attr("style", i.attr("style") + ";" + e),
            ...
            function _(t, e, n, r, i, s, a, u) {
                ...
                return e.empty(),
                h.get(x.getTrustedResourceUrl(m), {
                    cache: $
                }).success(function (f) {
                    var h, $;
                    if (f = Y(f),
                    v.replace) {
                        if (f = gr.test(f) ? Bn(or(f)) : [],
                        h = f[0],
                        1 != f.length || 1 !== h.nodeType)
                            throw Nr("tplrt", v.name, m);
                        f = {
                            $attr: {}
                        },
                        G(r, e, h);
                    ...
                    l = O(e[0].childNodes, i) ; p.length;) {
                        ...
                        if ($ !== d) {
                            var S = $.className;
                            u.hasElementTranscludeDirective && v.replace || (w = re(h)),
                            G(b, Bn($), w),
                            A(Bn(w), S)
                        }
                        $ = c.transcludeOnThisElement ? T(f, c.transclude, x) : x,
                        c(l, f, w, r, $)
                    }
                    p = null
                ...
                function (t, e, n, r, i) {
                    ...
                    p.push(n),
                    p.push(r),
                    p.push(t)) : (c.transcludeOnThisElement && (t = T(e, c.transclude, i)),
                    c(l, e, n, r, t))
                }
            }
            function I(t, e) {
            ...
            function H(t, e, n, r) {
                if (e)
                    throw Nr("multidir", e.name, n.name, t, U(r))
            }
            function L(t, e) {
                var n = r(e, !0);
                n && t.push({
                    ...
                    compile: function (t) {
                        ...
                        return e && A(t.parent(), "ng-binding"),
                        function (t, r) {
                            var i = r.parent()
                              , o = i.data("$binding") || [];
                            o.push(n),
            ...
            function z(t, e, n, i) {
                var o = r(n, !0);
                if (o) {
                    if ("multiple" === i && "SELECT" === Qn(t))
                        throw Nr("selmulti", U(t));
                    e.push({
                        priority: 100,
                        compile: function () {
                            return {
                                pre: function (e, n, s) {
                                    ...
                                    l.test(i))
                                        throw Nr("nodomevents");
                                    (o = r(s[i], !0, B(t, i))) && (s[i] = o(e),
                                    (n[i] || (n[i] = [])).$$inter = !0,
                ...
                if (t)
                    ...
                    o = t.length; o > i; i++)
                        if (t[i] == s) {
                            t[i++] = r,
                            o = i + a - 1;
                            for (var c = t.length; c > i; i++,
                            o++)
                                c > o ? t[i] = t[o] : delete t[i];
                            t.length -= a - 1;
                            break
                        }
                for (u && u.replaceChild(r, s),
                t = e.createDocumentFragment(),
                t.appendChild(s),
                r[Bn.expando] = s[Bn.expando],
                s = 1,
                a = n.length; a > s; s++)
                    u = n[s],
                    Bn(u).remove(),
            ...
            X.prototype = {
                ...
                $set: function (t, e, r, i) {
                    ...
                    s && (this.$$element.prop(t, e),
                    i = s),
                    this[t] = e,
                    i ? this.$attr[t] = i : (i = this.$attr[t]) || (this.$attr[t] = i = W(t, "-")),
                    s = Qn(this.$$element),
                    ("A" === s && "href" === t || "IMG" === s && "src" === t) && (this[t] = e = k(e, "src" === t)),
    ...
    function Ne() {
        ...
        this.$get = ["$injector", "$window", function (n, i) {
            return function (o, s) {
                ...
                u = a[1],
                c = a[3],
                o = t.hasOwnProperty(u) ? t[u] : X(s.$scope, u, !0) || X(i, u, !0),
                G(o, u, !0)),
                a = n.instantiate(o, s),
                c) {
    ...
    function qe() {
        var t = /^\s*(\[|\{[^\{])/
          ...
          , s = this.defaults = {
              transformResponse: [function (n) {
                  return w(n) && (n = n.replace(r, ""),
                  t.test(n) && e.test(n) && (n = V(n))),
                  n
              }
              ],
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (t, e, r, i, l, h) {
            ...
            function $(r, o, a) {
                function u(t, e, n, r) {
                    h && (t >= 200 && 300 > t ? h.put(x, [t, e, De(n), r]) : h.remove(x)),
                    c(e, t, n, r),
                    i.$$phase || i.$apply()
                }
                function c(t, e, n, i) {
                ...
                b.then(f, f),
                !r.cache && !s.cache || !1 === r.cache || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(s.cache) ? s.cache : v),
                h)
                    if ($ = h.get(x),
                    m($)) {
                        if ($ && S($.then))
                        ...
                        h.put(x, b);
                return g($) && (($ = xn(r.url) ? e.cookies()[r.xsrfCookieName || s.xsrfCookieName] : n) && (a[r.xsrfHeaderName || s.xsrfHeaderName] = $),
            ...
            function d(t, e) {
                ...
                return a(e, function (t, e) {
                    null === t || g(t) || (ir(t) || (t = [t]),
                    o(t, function (t) {
                        y(t) && (x(t) ? t = t.toISOString() : y(t) && (t = R(t))),
                        n.push(L(e) + "=" + L(t))
                    }))
                }),
    ...
    function Ue(e) {
        if (8 >= Ln && (!e.match(/^(get|post|head|put|delete|options)$/i) || !t.XMLHttpRequest))
    ...
    function _e(t, e, n, r, i) {
        function s(t, e, n) {
            ...
            s = function (t) {
                ...
                u = t.type,
                a = "error" === t.type ? 404 : 200),
                n && n(a, u)
            }
            ,
            fr(o, "load", s),
            fr(o, "error", s),
            8 >= Ln && (o.onreadystatechange = function () {
                ...
                x.onreadystatechange = function () {
                    if (x && 4 == x.readyState) {
                        var t = null
                          , e = null
                          , n = "";
                        y !== a && (t = x.getAllResponseHeaders(),
                        e = "response" in x ? x.response : x.responseText),
                        y === a && 10 > Ln || (n = x.statusText),
                        g(l, y || x.status, e, t, n)
                }
                }
                ,
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (n, r, i) {
            function o(o, u, c) {
                for (var l, f, h = 0, p = [], $ = o.length, d = !1, v = []; $ > h;)
                    -1 != (l = o.indexOf(t, h)) && -1 != (f = o.indexOf(e, l + s)) ? (h != l && p.push(o.substring(h, l)),
                    p.push(h = n(d = o.substring(l + s, f))),
                    h.exp = d,
                    h = f + a,
                    d = !0) : (h != $ && p.push(o.substring(h)),
                    h = $);
                if (($ = p.length) || (p.push(""),
                $ = 1),
                c && 1 < p.length)
                    ...
                    try {
                        for (var e, n = 0, s = $; s > n; n++) {
                            if ("function" == typeof (e = p[n]))
                                if (e = e(t),
                                e = c ? i.getTrusted(c, e) : i.valueOf(e),
                                null == e)
                                    e = "";
                                else
                                    switch (typeof e) {
    ...
    function He() {
        this.$get = ["$rootScope", "$window", "$q", function (t, e, n) {
            ...
            return r.cancel = function (t) {
                return t && t.$$intervalId in i ? (i[t.$$intervalId].reject("canceled"),
    ...
    function Xe(t, e) {
        ...
        this.$$rewrite = function (i) {
            var o;
            return (o = Qe(t, i)) !== n ? (i = o,
            (o = Qe(e, o)) !== n ? r + (Qe("/", o) || o) : t + i) : (o = Qe(r, i)) !== n ? r + o : r == i + "/" ? r : void 0
        }
    }
    function Ke(t, e) {
        var n = Je(t);
    ...
    function en() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (r, i, o, s) {
            ...
            n ? (l = h.substring(0, h.indexOf("/", h.indexOf("//") + 2)) + (f || "/"),
            c = o.history ? Xe : Ze) : (l = Ge(h),
            c = Ke),
            u = new c(l, "#" + e),
            u.$$parse(u.$$rewrite(h));
            ...
            s.on("click", function (n) {
                if (!n.ctrlKey && !n.metaKey && 2 != n.which) {
                    for (var o = Bn(n.target) ; "a" !== Jn(o[0].nodeName) ;)
                        if (o[0] === s[0] || !(o = o.parent())[0])
                            return;
                    var a = o.prop("href");
                    if (y(a) && "[object SVGAnimatedString]" === a.toString() && (a = bn(a.animVal).href),
                    !p.test(a)) {
                        if (c === Ze) {
                            ...
                            if (0 > f.indexOf("://"))
                                ...
                                "/" == f[0])
                                    ...
                                    for (var h = u.path().split("/"), f = f.split("/"), $ = 0; $ < f.length; $++)
                                        "." != f[$] && (".." == f[$] ? h.pop() : f[$].length && h.push(f[$]));
                                    a = l + a + h.join("/")
                                }
                        }
                        h = u.$$rewrite(a),
                        a && !o.attr("target") && h && !n.isDefaultPrevented() && (n.preventDefault(),
                        h != i.url() && (u.$$parse(h),
                        r.$apply(),
            ...
            i.onUrlChange(function (t) {
                u.absUrl() != t && (r.$evalAsync(function () {
                    var e = u.absUrl();
                    u.$$parse(t),
                    r.$broadcast("$locationChangeStart", t, e).defaultPrevented ? (u.$$parse(e),
                    i.url(e)) : a(e)
                }),
                r.$$phase || r.$digest())
            });
    ...
    function an(t, e, r, i, o, s, a) {
        ...
        rn(i, s),
        rn(o, s),
        a.unwrapPromises ? function (a, u) {
            var c, l = u && u.hasOwnProperty(t) ? u : a;
            return null == l ? l : ((l = l[t]) && l.then && (qr(s),
            "$$v" in l || (c = l,
            c.$$v = n,
            c.then(function (t) {
                c.$$v = t
        ...
        : function (s, a) {
            ...
            return null == u ? u : (u = u[t],
            e ? null == u ? n : (u = u[e],
            r ? null == u ? n : (u = u[r],
            i ? null == u ? n : (u = u[i],
            o ? null == u ? n : u = u[o] : u) : u) : u) : u)
        }
    }
    function un(t, e, r) {
        ...
        if (e.csp)
            i = 6 > a ? an(s[0], s[1], s[2], s[3], s[4], r, e) : function (t, i) {
                var o, u = 0;
                do
                    o = an(s[u++], s[u++], s[u++], s[u++], s[u++], r, e)(t, i),
                    i = n,
                    t = o;
                while (a > u); return o
            }
            ...
            c.toString = v(u),
            i = e.unwrapPromises ? function (t, e) {
                return c(t, e, qr)
            }
            : c
        }
        return "hasOwnProperty" !== t && (Qr[t] = i),
        i
    }
    function cn() {
        var t = {}
        ...
        this.unwrapPromises = function (t) {
            return m(t) ? (e.unwrapPromises = !!t,
            this) : e.unwrapPromises
        }
        ,
        this.logPromiseWarnings = function (t) {
            return m(t) ? (e.logPromiseWarnings = t,
            this) : e.logPromiseWarnings
        }
        ,
        this.$get = ["$filter", "$sniffer", "$log", function (n, r, i) {
            return e.csp = r.csp,
            qr = function (t) {
                e.logPromiseWarnings && !Fr.hasOwnProperty(t) && (Fr[t] = !0,
                i.warn("[$parse] Promise found in the expression `" + t + "`. Automatic unwrapping of promises in Angular expressions is deprecated."))
            }
            ,
            function (r) {
                var i;
                switch (typeof r) {
                    case "string":
                        return t.hasOwnProperty(r) ? t[r] : (i = new zr(e),
            ...
            return u = {
                ...
                promise: {
                    then: function (t, n, a) {
                        ...
                        return l ? l.push([c, f, h]) : o.then(c, f, h),
                        u.promise
                    },
                    "catch": function (t) {
            ...
            l.prototype = {
                        ...
                        if (y(n))
                            if (i(n))
                                ...
                                for (e in n)
                                    ...
                                    r.hasOwnProperty(e) ? (o = r[e] !== r[e] && n[e] !== n[e],
                                    o || r[e] === n[e] || (c++,
                                    r[e] = n[e])) : ($++,
                                    r[e] = n[e],
                                    c++));
                                if ($ > t)
                                    for (e in c++,
                                    r)
                                        r.hasOwnProperty(e) && !n.hasOwnProperty(e) && ($--,
                                        delete r[e])
                            }
                        else
                            r !== n && (r = n,
                        ...
                        t: do {
                            if (a = l.$$watchers)
                                for (u = a.length; u--;)
                                    try {
                                        if (r = a[u])
                                            if ((i = r.get(l)) === (o = r.last) || (r.eq ? P(i, o) : "number" == typeof i && "number" == typeof o && isNaN(i) && isNaN(o))) {
                                                if (r === n) {
                                                    c = !1;
                                                    break t
                                                }
                                                ...
                                                5 > y && (h = 4 - y,
                                                w[h] || (w[h] = []),
                                                p = S(r.exp) ? "fn: " + (r.exp.name || r.exp.toString()) : r.exp,
                                                p += "; newVal: " + R(i) + "; oldVal: " + R(o),
                                                w[h].push(p))
                                    } catch (x) {
                                        v.$$phase = null,
                                        s(x)
                            ...
                            if (!(a = l.$$childHead || l !== this && l.$$nextSibling))
                                for (; l !== this && !(a = l.$$nextSibling) ;)
                                    l = l.$parent
                        } while (l = a); if ((c || g.length) && !y--)
                            throw v.$$phase = null,
                            e("infdig", t, R(w))
                    } while (c || g.length); for (v.$$phase = null; m.length;)
                        try {
                            m.shift()()
                        } catch (C) {
                            s(C)
                ...
                $destroy: function () {
                    if (!this.$$destroyed) {
                        ...
                        this.$$destroyed = !0,
                        this !== v && (o(this.$$listenerCount, j(null, p, this)),
    ...
    function gn() {
        ...
        this.resourceUrlWhitelist = function (e) {
            return arguments.length && (t = vn(e)),
            t
        }
        ,
        this.resourceUrlBlacklist = function (t) {
            return arguments.length && (e = vn(t)),
            e
        }
        ,
            ...
            a[Jr.RESOURCE_URL] = i(a[Jr.URL]),
            {
                ...
                getTrusted: function (r, i) {
                    ...
                    if (r === Jr.RESOURCE_URL) {
                        ...
                        for (u = 0,
                        c = t.length; c > u; u++)
                            if ("self" === t[u] ? xn(s) : t[u].exec(s.href)) {
                                l = !0;
                                break
                            }
                        if (l)
                            for (u = 0,
                            c = e.length; c > u; u++)
                                if ("self" === e[u] ? xn(s) : e[u].exec(s.href)) {
                                    l = !1;
                                    break
                                }
                        if (l)
    ...
    function yn() {
        this.$get = ["$window", "$document", function (t, e) {
            ...
            if (c) {
                ...
                !i || l && f || (l = w(s.body.style.webkitTransition),
    ...
    function wn() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (t, e, n, r) {
            ...
            return i.cancel = function (t) {
                return t && t.$$timeoutId in o ? (o[t.$$timeoutId].reject("canceled"),
    ...
    function bn(t) {
        var e = t;
        return Ln && (Xr.setAttribute("href", e),
        e = Xr.href),
        Xr.setAttribute("href", e),
        {
            href: Xr.href,
    ...
    function xn(t) {
        return t = w(t) ? bn(t) : t,
        t.protocol === Kr.protocol && t.host === Kr.host
    }
    function Sn() {
        this.$get = v(t)
    }
        ...
        return function (t, e, n) {
            ...
            : function (t, e) {
                if (t && e && "object" == typeof t && "object" == typeof e) {
                    for (var r in t)
                        if ("$" !== r.charAt(0) && Xn.call(t, r) && n(t[r], e[r]))
                            return !0;
                    return !1
                }
    ...
    function En(t) {
        ...
        return function (t, n) {
            ...
            On(t, e.PATTERNS[1], e.GROUP_SEP, e.DECIMAL_SEP, 2).replace(/\u00A4/g, n)
        }
    }
    function An(t) {
        var e = t.NUMBER_FORMATS;
    ...
    function Pn(t) {
        ...
        return function (n, r) {
            ...
            w(n) && (n = ei.test(n) ? h(n) : e(n)),
            b(n) && (n = new Date(n)),
            !x(n))
                return n;
            for (; r;)
                (s = ti.exec(r)) ? (u = u.concat(Zn.call(s, 1)),
                r = u.pop()) : (u.push(r),
                r = null);
            return o(u, function (e) {
                i = Yr[e],
                a += i ? i(n, t.DATETIME_FORMATS) : e.replace(/(^'|'$)/g, "").replace(/''/g, "'")
            }),
            a
        }
    }
    ...
    function Dn() {
        return function (t, e) {
            if (!ir(t) && !w(t))
                return t;
            if (e = 1 / 0 === Math.abs(Number(e)) ? Number(e) : h(e),
            w(t))
                return e ? e >= 0 ? t.slice(0, e) : t.slice(e, t.length) : "";
            var n, r, i = [];
            for (e > t.length ? e = t.length : e < -t.length && (e = -t.length),
            e > 0 ? (n = 0,
            r = e) : (n = t.length + e,
            r = t.length) ; r > n; n++)
                i.push(t[n]);
    ...
    function Rn(t) {
        return function (e, n, r) {
            ...
            function o(t, e) {
                var n = typeof t
                  , r = typeof e;
                return n == r ? (x(t) && x(e) && (t = t.valueOf(),
                e = e.valueOf()),
                "string" == n && (t = t.toLowerCase(),
                e = e.toLowerCase()),
                t === e ? 0 : e > t ? -1 : 1) : r > n ? -1 : 1
            }
            if (!ir(e) || !n)
                return e;
            n = ir(n) ? n : [n],
    ...
    function qn(t, e, n, r) {
        function i(e, n) {
            n = n ? "-" + W(n, "-") : "",
            r.removeClass(t, (e ? gi : vi) + n),
            r.addClass(t, (e ? vi : gi) + n)
        }
        var s = this
          , a = t.parent().controller("form") || si
          , u = 0
          , c = s.$error = {}
          , l = [];
    ...
    function _n(t, e, n, r, i) {
        y(i) && (t.$$hasNativeValidators = !0,
        t.$parsers.push(function (o) {
    ...
    function In(t, e, n, i, o, s) {
        ...
        var f = function (r) {
            if (!l) {
                var o = e.val();
                Ln && "input" === (r || c).type && e[0].placeholder !== u ? u = e[0].placeholder : (q(n.ngTrim || "T") && (o = or(o)),
                r = a && i.$$hasNativeValidators,
                (i.$viewValue !== o || "" === o && r) && (t.$$phase ? i.$setViewValue(o) : t.$apply(function () {
                    i.$setViewValue(o)
                })))
            }
        };
        if (o.hasEvent("input"))
            ...
            e.on("keydown", function (t) {
                t = t.keyCode,
                91 === t || t > 15 && 19 > t || t >= 37 && 40 >= t || $()
            }),
            o.hasEvent("paste") && e.on("paste cut", $)
        }
        e.on("change", f),
        i.$render = function () {
        ...
        ;
        var d = n.ngPattern;
        if (d && ((o = d.match(/^\/(.*)\/([gim]*)$/)) ? (d = RegExp(o[1], o[2]),
        o = function (t) {
            return Un(i, "pattern", i.$isEmpty(t) || d.test(t), t)
        }
        ) : o = function (n) {
            var o = t.$eval(d);
            if (!o || !o.test)
                throw r("ngPattern")("noregexp", d, o, U(e));
        ...
        n.ngMinlength) {
            ...
            o = function (t) {
                return Un(i, "minlength", i.$isEmpty(t) || t.length >= v, t)
            }
            ,
            i.$parsers.push(o),
            i.$formatters.push(o)
        ...
        if (n.ngMaxlength) {
            var g = h(n.ngMaxlength);
            o = function (t) {
                return Un(i, "maxlength", i.$isEmpty(t) || t.length <= g, t)
            }
            ,
            i.$parsers.push(o),
            i.$formatters.push(o)
    ...
    Ln = h((/msie (\d+)/.exec(Jn(navigator.userAgent)) || [])[1]),
    isNaN(Ln) && (Ln = h((/trident\/.*; rv:(\d+)/.exec(Jn(navigator.userAgent)) || [])[1])),
    $.$inject = [],
    d.$inject = [];
    var ir = function () {
    ...
    var cr = ne.cache = {}
      , lr = 1
      , fr = t.document.addEventListener ? function (t, e, n) {
    ...
    var br = ne.prototype = {
        ready: function (n) {
            ...
            var i = !1;
            "complete" === e.readyState ? setTimeout(r) : (this.on("DOMContentLoaded", r),
            ne(t).on("load", r))
        },
        toString: function () {
            var t = [];
    ...
    o({
        ...
        css: function (t, e, r) {
            ...
            !m(r)) {
                var i;
                return 8 >= Ln && (i = t.currentStyle && t.currentStyle[e],
                "" === i && (i = "auto")),
                i = i || t.style[e],
                8 >= Ln && (i = "" === i ? n : i),
                i
        ...
        text: function () {
            ...
            var e = [];
            return 9 > Ln ? (e[1] = "innerText",
            e[3] = "nodeValue") : e[1] = e[3] = "textContent",
            t.$dv = "",
            t
        }(),
        val: function (t, e) {
    ...
    o({
        removeData: se,
        dealoc: ie,
        on: function no(t, n, r, i) {
            if (m(i))
                throw dr("onargs");
            var s = ae(t, "events")
              , a = ae(t, "handle");
            s || ae(t, "events", s = {}),
            a || ae(t, "handle", a = ge(t, s)),
        ...
        ne.prototype[e] = function (e, n, r) {
            for (var i, o = 0; o < this.length; o++)
                g(i) ? (i = t(this[o], e, n, r),
                m(i) && (i = Bn(i))) : he(i, t(this[o], e, n, r));
            return m(i) ? i : this
        }
        ,
        ...
        readString: function (t) {
            ...
            for (var n = "", r = t, i = !1; this.index < this.text.length;) {
                var o = this.text.charAt(this.index)
                  , r = r + o;
                if (i)
                    "u" === o ? (i = this.text.substring(this.index + 1, this.index + 5),
                    i.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + i + "]"),
                    this.index += 4,
                    n += String.fromCharCode(parseInt(i, 16))) : n += Br[o] || o,
                    i = !1;
                else if ("\\" === o)
                    i = !0;
                else {
    ...
    Wr.prototype = {
        ...
        primary: function () {
            ...
            for (var n; e = this.expect("(", "[", ".") ;)
                "(" === e.text ? (t = this.functionCall(t, n),
                n = null) : "[" === e.text ? (n = t,
        ...
        expect: function (t, e, n, r) {
            return (t = this.peek(t, e, n, r)) ? (this.tokens.shift(),
            t) : !1
        },
        consume: function (t) {
        ...
        statements: function () {
            for (var t = []; ;)
                if (0 < this.tokens.length && !this.peek("}", ")", ";", "]") && t.push(this.filterChain()),
                !this.expect(";"))
        ...
        fieldAccess: function (t) {
            var e = this
              , n = this.expect().text
              , r = un(n, this.options, this.text);
            return f(function (e, n, i) {
                return r(i || t(e, n))
            }, {
                assign: function (r, i, o) {
                    return (o = t(r, o)) || t.assign(r, o = {}),
                    sn(o, n, i, e.text, e.options)
                }
            })
        },
        objectIndex: function (t) {
            ...
            f(function (i, o) {
                ...
                return rn(u, e.text),
                a ? ((a = on(a[u], e.text)) && a.then && e.options.unwrapPromises && (s = a,
                "$$v" in a || (s.$$v = n,
                s.then(function (t) {
                    s.$$v = t
                })),
                ...
                assign: function (n, i, o) {
                    ...
                    return (o = on(t(n, o), e.text)) || t.assign(n, o = {}),
                    o[s] = i
                }
            })
        },
    ...
    var Qr = {}
      ...
      , Xr = e.createElement("a")
      , Kr = bn(t.location.href, !0);
    Cn.$inject = ["$provide"],
    En.$inject = ["$locale"],
    An.$inject = ["$locale"];
    var Zr = "."
      , Yr = {
          ...
          Z: function (t) {
              ...
              t = (t >= 0 ? "+" : "") + (Tn(Math[t > 0 ? "floor" : "ceil"](t / 60), 2) + Tn(Math.abs(t % 60), 2))
          }
      }
      , ti = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/
      , ei = /^\-?\d+$/;
    Pn.$inject = ["$locale"];
    var ni = v(Jn)
      , ri = v(Kn);
    ...
    var ii = v({
        ...
        compile: function (t, n) {
            return 8 >= Ln && (n.href || n.name || n.$set("href", ""),
            t.append(e.createComment("IE fix"))),
    ...
    var ai = function (t) {
      ...
      , pi = {
          ...
          number: function (t, e, r, i, o, s) {
              ...
              i.$parsers.push(function (t) {
                  var e = i.$isEmpty(t);
                  return e || hi.test(t) ? (i.$setValidity("number", !0),
      ...
      , $i = ["badInput"]
      , di = ["$browser", "$sniffer", function (t, e) {
          return {
              restrict: "E",
              require: "?ngModel",
      ...
      , mi = "ng-pristine"
      , yi = "ng-dirty"
      , wi = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function (t, e, n, i, s, a) {
          function u(t, e) {
              e = e ? "-" + W(e, "-") : "",
          ...
          var c = s(n.ngModel)
            , l = c.assign;
          if (!l)
              throw r("ngModel")("nonassign", n.ngModel, U(i));
          this.$render = $,
          this.$isEmpty = function (t) {
              return g(t) || "" === t || null === t || t !== t
          }
          ;
          var f = i.inheritedData("$formController") || si
            , h = 0
            , p = this.$error = {};
          i.addClass(mi),
          u(!0),
    ...
    var Vi = ["$animate", function (t) {
      ...
      , Ii = ["$locale", "$interpolate", function (t, e) {
          var n = /{}/g;
          return {
              restrict: "EA",
              link: function (r, i, s) {
                  ...
                  r.$watch(function () {
                      ...
                      return isNaN(e) ? "" : (e in l || (e = t.pluralCat(e - c)),
                      f[e](r, i, !0))
                  }, function (t) {
                      i.text(t)
                  })
      ...
      , Hi = ["$parse", "$animate", function (t, n) {
          ...
          return {
              ...
              link: function (r, a, u, c, l) {
                  var f, h, p, $, d, v, g = u.ngRepeat, m = g.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), y = {
                      $id: me
                  };
                  if (!m)
                      throw s("iexp", g);
                  ...
                  r.$watchCollection(c, function (t) {
                      ...
                      if (i(t))
                          ...
                          S = [];
                          for (b in t)
                              t.hasOwnProperty(b) && "$" != b.charAt(0) && S.push(b);
                          S.sort()
                      }
                      for (m = S.length,
                      c = A.length = S.length,
                      ...
                      c = S.length; c > u; u++) {
                          ...
                          x = t[b],
                          C = A[u],
                          A[u - 1] && (k = A[u - 1].clone[A[u - 1].clone.length - 1]),
                          C.scope) {
                              y = C.scope,
                              f = k;
                              do
                                  f = f.nextSibling;
                              while (f && f.$$NG_REMOVED); C.clone[0] != f && n.move(K(C.clone), null, Bn(k)),
                              k = C.clone[C.clone.length - 1]
                          } else
                              y = r.$new();
                          y[d] = x,
                          v && (y[v] = b),
          ...
          return {
              ...
              link: function (e, n, r, i) {
                  ...
                  e.$watch(r.ngSwitch || r.on, function (n) {
                      ...
                      a.length = 0,
                      c.length = 0,
                      (s = i.cases["!" + n] || i.cases["?"]) && (e.$eval(r.change),
                      o(s, function (n) {
                          var r = e.$new();
                          c.push(r),
      ...
      , Ji = Vn({
          link: function (t, e, n, i, o) {
              if (!o)
                  throw r("ngTransclude")("orphan", U(e));
              o(function (t) {
                  e.empty(),
                  e.append(t)
              })
          ...
          return {
              ...
              link: function (a, u, c, l) {
                  function f(t, e, n, r) {
                      n.$render = function () {
                          var t = n.$viewValue;
                          r.hasOption(t) ? (S.parent() && S.remove(),
                          e.val(t),
                          "" === t && d.prop("selected", !0)) : g(t) && d ? e.val("") : r.renderUnknownOption(t)
                      }
                      ,
                  ...
                  function h(t, e, n) {
                      ...
                      ,
                      t.$watch(function () {
                          P(r, n.$viewValue) || (r = N(n.$viewValue),
                          n.$render())
                      }),
                      e.on("change", function () {
                          t.$apply(function () {
                  ...
                  function p(e, o, a) {
                      function u() {
                          ...
                          C > E; E++) {
                              ...
                              (n = c[t]) || (n = c[t] = [],
                              y.push(t)),
                              v ? t = m(u.remove(g ? g(e, k) : $(e, k))) : (g ? (t = {},
                              t[f] = r,
                              t = g(e, t) === g(e, k)) : t = r === $(e, k),
                              u = u || t),
                              O = l(e, k),
                              O = m(O) ? O : "",
                              n.push({
                          ...
                          A = y.length; A > k; k++) {
                              ...
                              i = [r],
                              S.push(i),
                              o.append(r.element)) : (i = S[k],
                              r = i[0],
                              r.label != t && r.element.attr("label", r.label = t)),
                              O = null,
                              E = 0,
                              C = n.length; C > E; E++)
                                  t = n[E],
                                  (u = i[E + 1]) ? (O = u.element,
                                  u.label !== t.label && O.text(u.label = t.label),
                                  u.id !== t.id && O.val(u.id = t.id),
                                  O[0].selected !== t.selected && (O.prop("selected", u.selected = t.selected),
                                  Ln && O.prop("selected", u.selected))) : ("" === t.id && w ? T = w : (T = b.clone()).val(t.id).prop("selected", t.selected).attr("selected", t.selected).text(t.label),
                                  i.push({
                                      element: T,
                                      label: t.label,
                                      id: t.id,
                                  ...
                                  O ? O.after(T) : r.element.append(T),
                                  O = T);
                              for (E++; i.length > E;)
                                  i.pop().element.remove()
                          }
                          for (; S.length > k;)
                              S.pop()[0].element.remove()
                      }
                      var c;
                      if (!(c = y.match(i)))
                          throw Ki("iexp", y, U(o));
